...
router.get(
  ...
  jwtAuthentification.CheckUserIsModeratorOrAdministrator.bind(jwtAuthentification),
 ...
 *   post:
 *     summary: Permet de récupérer les vitrines active dans un rayon de 30 km autour des coordonnées
 *     tags: [Vitrines]
 *     parameters:
 *       - in: path
 *         name: deviceLat
 ...
 *   name: Vitrines
 *   description: CRUD vitrines
 * /vitrines/{deviceLat}/{deviceLng}:
 *   get:
 *     summary: Permet de récupérer le comptage du nombre de vitrine dans la zone géographique choisie
 *     tags: [Vitrines]
 *     parameters:
 *       - in: path
 *         name: deviceLat
 ...
 *
 */
router.get('/:deviceLat/:deviceLng', jwtAuthentification.CheckTokenValidity.bind(jwtAuthentification), jwtAuthentification.CheckUserIsAdministrator.bind(jwtAuthentification), vitrinesService.GetAllVitrineWithCoordinate.bind(vitrinesService));
